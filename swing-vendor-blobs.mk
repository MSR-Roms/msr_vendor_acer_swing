...
PRODUCT_COPY_FILES += \
    ...
    $(VENDOR_BLOB_FOLDER)/etc/gps.conf:system/etc/gps.conf \
    $(VENDOR_BLOB_FOLDER)/etc/permissions/com.qualcomm.location.quipslib.xml:system/etc/permissions/com.qualcomm.location.quipslib.xml \
    $(VENDOR_BLOB_FOLDER)/etc/permissions/android.hardware.location.gps.xml:system/etc/permissions/android.hardware.location.gps.xml \
    $(VENDOR_BLOB_FOLDER)/etc/permissions/com.qualcomm.location.vzw_library.xml:system/etc/permissions/com.qualcomm.location.vzw_library.xml \
    ...
    $(VENDOR_BLOB_FOLDER)/lib/libcameraservice.so:system/lib/libcameraservice.so \
    ...
    $(VENDOR_BLOB_FOLDER)/lib/libjni_acerAgpsSetting.so:system/lib/libjni_acerAgpsSetting.so \
    ...
    $(VENDOR_BLOB_FOLDER)/lib/hw/audio.a2dp.default.so:system/lib/hw/audio.a2dp.default.so \
    $(VENDOR_BLOB_FOLDER)/lib/hw/gps.msm8960.so:system/lib/hw/gps.msm8960.so \
    $(VENDOR_BLOB_FOLDER)/lib/hw/gps.goldfish.so:system/lib/hw/gps.goldfish.so \
...
PRODUCT_COPY_FILES +=  \
    ...
    $(VENDOR_BLOB_FOLDER)/framework/com.android.location.provider.jar:system/framework/com.android.location.provider.jar \
    $(VENDOR_BLOB_FOLDER)/framework/com.qualcomm.location.vzw_library.jar:system/framework/com.qualcomm.location.vzw_library.jar \
    $(VENDOR_BLOB_FOLDER)/framework/org.codeaurora.Performance.jar:system/framework/org.codeaurora.Performance.jar \
    $(VENDOR_BLOB_FOLDER)/framework/org.simalliance.openmobileapi.jar:system/framework/org.simalliance.openmobileapi.jar \
    $(VENDOR_BLOB_FOLDER)/app/com.qualcomm.services.location.apk:system/app/com.qualcomm.services.location.apk \
    $(VENDOR_BLOB_FOLDER)/framework/requestsync.jar:system/framework/requestsync.jar \
    $(VENDOR_BLOB_FOLDER)/lib/libalarmservice_jni.so:system/lib/libalarmservice_jni.so \
    $(VENDOR_BLOB_FOLDER)/lib/libclcore.bc:system/lib/libclcore.bc \
    $(VENDOR_BLOB_FOLDER)/lib/libclcore_neon.bc:system/lib/libclcore_neon.bc \
    $(VENDOR_BLOB_FOLDER)/lib/libwvm.so:system/lib/libwvm.so
